...
export declare function fetchNotification(): Promise<any>;
export declare function fetchAndSetNotification(): Promise<void>;
export declare function useDocument(): TEditorConfiguration;
export declare function useNotification(): any;
